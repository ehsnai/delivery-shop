...
const requestData = (userType,sorted,pageSize,page,searchText,dateStart,dateEnd) => {
  ...
  return new Promise((resolve, reject) => {
      ...
      axios({
          ...
          url: `${API_URL}users?page=${page}&pageSize=${pageSize}&sOrderBy=${orderBy}&sDesc=${desc}&wheres=${searchText}&dateStart=${dateStart}&dateEnd=${dateEnd}`,
          headers: {
          ...
          <Card>
            <CardHeader color="rose" icon>
              ...
              <h4 className={classes.cardIconTitle}>
                Delivery
                <small> - <Link to={`/admin/product`} >Delivery List</Link> </small>                               
              </h4>
