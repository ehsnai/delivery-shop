...
module.exports = [
    ...
    },
    {
        ...
        config: {
            tags: ['api', 'tickets'],
            description: 'This API is used to Post tickets Data from admin.',
            auth: "adminJwt",
            validate: {
                headers: headerValidator.headerAuthValidator,
    ...
    {
        method: 'PUT',
        path: '/ticketMultipleDelete',
        handler: PostDeleteAll.APIHandler,
        config: {
            tags: ['api', 'tickets'],
            description: 'This API is used to Delete multiple tickets from admin.',
            auth: "adminJwt",
            validate: {
                headers: headerValidator.headerAuthValidator,
    ...
    },
    {
        ...
        config: {
            tags: ['api', 'tickets'],
            description: 'This API is used to update tickets data from admin.',
            auth: "adminJwt",
            validate: {
                headers: headerValidator.headerAuthValidator,
